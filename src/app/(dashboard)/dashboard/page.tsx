      ...
      <nav style={styles.nav}>
        ...
        <div style={styles.navRight}>
          ...
          <form action="/api/auth/signout" method="POST">
            <button style={styles.signoutBtn} type="submit">Sign out</button>
          </form>
        </div>
      </nav>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  subBanner: {
    ...
    marginBottom: '2rem', flexWrap: 'wrap', gap: '12px',
  ...
  statValue: { fontSize: '16px', fontWeight: 700, color: '#fff', textTransform: 'capitalize' as const },
